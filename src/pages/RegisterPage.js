...
// RegisterPage.js – הקובץ שלך כולל העלאת תמונת פרופיל
// import React, { useState } from 'react';
// import { useNavigate, Link } from 'react-router-dom';
// import {
//   Box,
...
//           <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
//             <TextField label="Username" name="username" fullWidth required value={formData.username} onChange={handleChange} />
//             <Grid container spacing={2}>
//               <Grid item xs={12} sm={6}>
//                 <TextField label="First Name" name="firstName" fullWidth required value={formData.firstName} onChange={handleChange} />
//               </Grid>
//               <Grid item xs={12} sm={6}>
//                 <TextField label="Last Name" name="lastName" fullWidth required value={formData.lastName} onChange={handleChange} />
//               </Grid>
//             </Grid>
...
//             <TextField label="Password" name="password" type={showPassword ? 'text' : 'password'} fullWidth required value={formData.password} onChange={handleChange}
...
//             {/* תמונת פרופיל */}
//             <Box>
//               <Typography variant="body2">Profile Image (optional):</Typography>
