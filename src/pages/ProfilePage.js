...
// import React, { useEffect, useState } from 'react';
// import {
//   Avatar, Box, Typography, Tabs, Tab, Button, Grid,
...
//         setMyRecipes(data);
//       } catch (err) {
//         setSnackbar({ open: true, message: "Failed to fetch my recipes", severity: "error" });
//       }
//     };
...
//         setLikedRecipes(data.recipes);
//       } catch (err) {
//         setSnackbar({ open: true, message: "Failed to fetch liked recipes", severity: "error" });
//       }
//     };
...
//     setSelectedTab(0); // switch to "My Recipes"
//   };
...
//         }}
//       >
//         <Avatar src={user.profileImage} alt="Profile" sx={{ width: 96, height: 96 }} />
//         <Box>
//           <Typography variant="h5" fontWeight="bold">
//             {`${user.firstName} ${user.lastName}` || 'שם מלא לא קיים'}
//           </Typography>
...
//       <Box display="flex" justifyContent="center" mb={2}>
//         <Button variant="contained" onClick={() => setOpen(true)} sx={{ backgroundColor: "#ff6600" }}>
//           Upload Recipe 📸
//         </Button>
//       </Box>
...
//         textColor="inherit"
//       >
//         <Tab label="My Recipes" sx={{ color: selectedTab === 0 ? 'black' : 'gray', fontWeight: selectedTab === 0 ? 'bold' : 'normal' }} />
//         <Tab label="Liked Recipes" sx={{ color: selectedTab === 1 ? 'black' : 'gray', fontWeight: selectedTab === 1 ? 'bold' : 'normal' }} />
//       </Tabs>
