        ...
        <Box sx={{ maxWidth: 1100, margin: 'auto', p: 2 }}>
          <Grid container spacing={2}>
            <Grid item xs={12} md={4}>
              <Card sx={{ mb: 3, padding: 3, boxShadow: '0 4px 15px rgba(0, 0, 0, 0.1)', borderRadius: 2 }}>
                <CardContent>
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, mb: 3 }}>
                    ...
                    <Box sx={{ textAlign: 'center' }}>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'center', gap: 4, mt: 2 }}>
                        <Box sx={{ textAlign: 'center' }}>
                          <Typography fontWeight="700" color="text.primary" sx={{ fontSize: 18 }}>
                            {myRecipes.length}
                          </Typography>
                          <Typography fontSize={14} color="text.secondary">Recipes</Typography>
                        </Box>
                        <Box sx={{ textAlign: 'center' }}>
                          <Typography fontWeight="700" color="text.primary" sx={{ fontSize: 18 }}>
                            {likedRecipes.length}
                          </Typography>
                          <Typography fontSize={14} color="text.secondary">Liked</Typography>
                        </Box>
                      </Box>
            ...
            <Grid item xs={12} md={8}>
              ...
              <Card sx={{ mt: 3, padding: 3, boxShadow: '0 4px 15px rgba(0, 0, 0, 0.1)', borderRadius: 2 }}>
                <Grid container spacing={2}>
                  {selectedTab === 0 ? (
                    myRecipes.length > 0 ? (
                      myRecipes.map((r) => (
